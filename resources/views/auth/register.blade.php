                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('area') ? ' has-error' : '' }}">
                            ...
                            <select class="form-control" name="area" value="{{ old('area') }}" required autofocus>
                              <option value="Acompañamiento Integral">Acompañamiento Integral</option>
                              <option value="Cultura">Cultura</option>
                              <option value="Actividad Física y Deportes">Actividad Física y Deportes</option>
                              <option value="Gestión y Fomento Socieconómico">Gestión y Fomento Socieconómico</option>
